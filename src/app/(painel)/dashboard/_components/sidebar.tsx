                ...
                <Collapsible open={!isCollapsed}>
                    <CollapsibleContent>
                        <nav className="flex flex-col gap-1 overflow-hidden">
                            <span className="text-sm font-medium text-gray-400 mt-1 uppercase">
                                Painel
                            </span>
                ...
                <header className="md:hidden flex items-center justify-between border-b px-2 md:px-6 h-14 z-10 sticky top-0 bg-white">
                    <Sheet>
                        <div className="flex items-center gap-4">
                            ...
                            <h1 className="text-base md:text-lg font-semibold">Menu OdontoPRO
                            </h1>
                        </div>
...
function SidebarLink({ href, icon, isCollapsed, label, pathname }: SidebarLinkProps) {
    return (
        <Link
            href={href}>
            <div
                className={clsx("flex items-center gap-2 bg-blue-500 px-3 py-4 rounded-md text-white transition-colors", {
