            ...
            <div className="container mx-auto px-4 pt-20 sm:px-6 lg:px-8">
                <main className="flex items-center justify-center">
                    <article className="flex-[2] space-y-8 max-w-3xl flex flex-col justify-center">
                        <h1 className="text-4xl lg:text-6xl font-bold text-gray-800 max-w-2xl tracking-tight">Encontre os melhores profissionais em um único local !</h1>
                        ...
                        <Button className="bg-emerald-500 hover:bg-emerald-700 text-white duration-300 w-fit px-6 font-semibold">
